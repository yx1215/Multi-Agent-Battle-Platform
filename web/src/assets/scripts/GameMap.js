...
export class GameMap extends AcGameObjects {
    ...
    // check if cell is wall or a snake cell
    check_valid(cell){
        ...
        for (const snake of this.snakes){
            ...
            // if the snake is not increasing, we can reach the original tail.
    ...
    // check if snakes are ready to move
    check_ready() {
        for (const snake of this.snakes){
